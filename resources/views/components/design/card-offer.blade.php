...
<a href="" class="h-96 w-full">
    <div class="relative flex flex-col rounded-md shadow-inner w-full h-full bg-gradient-to-br from-red-700 to-yellow-500 px-3 py-6 transform hover:-translate-y-1 hover:scale-110 duration-300 ease-in-out">
        <svg class="absolute bottom-0 left-0 mb-8 z-40 fill-current text-white"  xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" style="transform: scale(1); opacity: 0.1;">
            <g id="XMLID_3497_">
                <g id="XMLID_3504_">
                ...
                <g id="XMLID_3499_">
                    <g id="XMLID_3500_">
                        <g id="XMLID_3503_">
                            <path id="XMLID_4286_" d="m228.317 417.919c-1.467 0-2.954-.323-4.361-1.007-4.969-2.412-7.04-8.396-4.627-13.363l55.024-113.306c2.412-4.969 8.398-7.039 13.363-4.627 4.968 2.412 7.04 8.396 4.627 13.363l-55.024 113.306c-1.728 3.561-5.293 5.634-9.002 5.634z"/>
                        </g>
                        <g id="XMLID_3502_">
                            <path id="XMLID_4283_" d="m207.203 334.637c-17.647 0-32.005-14.357-32.005-32.006s14.357-32.006 32.005-32.006 32.006 14.357 32.006 32.006-14.357 32.006-32.006 32.006zm0-44.012c-6.619 0-12.005 5.386-12.005 12.006s5.386 12.006 12.005 12.006c6.62 0 12.006-5.386 12.006-12.006s-5.386-12.006-12.006-12.006z"/>
                        </g>
                        <g id="XMLID_3501_">
                            <path id="XMLID_4280_" d="m304.797 432.229c-17.648 0-32.006-14.357-32.006-32.005s14.357-32.006 32.006-32.006c17.647 0 32.005 14.357 32.005 32.006 0 17.648-14.358 32.005-32.005 32.005zm0-44.01c-6.62 0-12.006 5.386-12.006 12.006 0 6.619 5.386 12.005 12.006 12.005 6.619 0 12.005-5.386 12.005-12.005 0-6.621-5.386-12.006-12.005-12.006z"/>
                        </g>
                    </g>
                </g>
                <g id="XMLID_3498_">
                    <path id="XMLID_4279_" d="m400.359 453.189c-2.64 0-5.22-1.069-7.079-2.93-1.86-1.86-2.921-4.44-2.921-7.07 0-2.64 1.061-5.21 2.921-7.069 1.859-1.86 4.439-2.931 7.079-2.931 2.631 0 5.2 1.07 7.061 2.931 1.87 1.859 2.939 4.439 2.939 7.069s-1.069 5.21-2.939 7.07c-1.86 1.861-4.43 2.93-7.061 2.93z"/>
                </g>
            </g>
        </svg>
        ...
        <div class="flex flex-col space-y-3 h-1/4">
            <span class="text-black font-bold text-center text-xl">
               {{$trademark}}
            </span>
        ...
        <div class="flex flex-col-reverse items-center h-1/4">
            <span class="bg-yellow-100 text-lg text-red-900 font-extrabold text-center rounded-full px-6 py-3 leading-3 w-1/2">
               {{$price}}
            </span>
        </div>
    </div>
