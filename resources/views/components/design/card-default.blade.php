...
<a href="" class="h-96 w-full">
    <div class="relative flex flex-col rounded-md shadow-inner w-full h-full bg-gradient-to-t from-turquoise-dark to-turquoise-light px-3 py-6 transform hover:-translate-y-1 hover:scale-110 duration-300 ease-in-out">
