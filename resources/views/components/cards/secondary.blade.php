...
<a href="" class="h-96 w-full">
    <div class="relative flex flex-col rounded-md shadow-inner w-full h-full opacity-90 bg-blue-900 px-3 py-6 transform hover:-translate-y-1 hover:scale-110 duration-300 ease-in-out">
