<div>
    <x-containers.main>
        ...
        <div x-data="{ tab:['trademark','category','subcategory','origin','warehouse','product','provider','stock'] }">
                <button :class="{ 'active': tab === 'trademark' }" @click="tab = 'trademark'">
                   Trademark
                </button>
                <button :class="{ 'active': tab === 'category' }" @click="tab = 'category'">
                    Category
                </button>
                <button :class="{ 'active': tab === 'subcategory' }" @click="tab = 'subcategory'">
                    Subcategory
                </button>
                <button :class="{ 'active': tab === 'origin' }" @click="tab = 'origin'">
                    Origin
                </button>
                <button :class="{ 'active': tab === 'warehouse' }" @click="tab = 'warehouse'">
                    Warehouse
                </button>
                <button :class="{ 'active': tab === 'product' }" @click="tab = 'product'">
                    Product
                </button>
                <button :class="{ 'active': tab === 'provider' }" @click="tab = 'provider'">
                    Provider
                </button>
