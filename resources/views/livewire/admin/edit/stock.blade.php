...
{{--Ventana Modal--}}
    <x-jet-dialog-modal wire:model="is_show">
		...
		<x-slot name="content">
            ...
            <dl>
               <div class="bg-gray-50 text-sm font-medium text-gray-500 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        ...
                        focus:border-blue-700 text-base text-gray-400" wire:model="stock.provider_id" >
                ...
                <div class="bg-gray-50 text-sm font-medium text-gray-500 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <select class="border border-gray-400 rounded-md w-full focus:outline-none px-3 
                        focus:border-blue-700 text-base text-gray-400" wire:model="stock.warehouse_id" >
                        <option value="">Seleccionar..</option>
